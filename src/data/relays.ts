...
export const relays: Relay[] = [
  // 1) AgentRouter
  {
    ...
    models: {
      ...
      "anthropic/claude-opus-4.8": m("anthropic/claude-opus-4.8", "Claude Opus 4.8"),
      "anthropic/claude-opus-5": m("anthropic/claude-opus-5", "Claude Opus 5"),
      "openai/gpt-5.6-sol": m("openai/gpt-5.6-sol", "GPT-5.6 Sol"),
    },
  },
  ...
  // 3) 魔塔社区 ModelScope
  {
    ...
    providers: ["deepseek", "qwen", "meta", "zhipu"],
    model_count: 0,
    region: ["cn", "global"],
    status: "operational",
    updated_at: "2026-08-20",
  ...
  // 6) 硅基流动 SiliconFlow
  {
    ...
    models: {
      ...
      "deepseek/deepseek-v4-flash": m("deepseek/deepseek-v4-flash", "DeepSeek V4 Flash"),
      "deepseek/deepseek-v4-pro": m("deepseek/deepseek-v4-pro", "DeepSeek V4 Pro"),
      "zhipu/glm-5.2": m("zhipu/glm-5.2", "GLM-5.2"),
      "moonshot/kimi-k2.5": m("moonshot/kimi-k2.5", "Kimi K2.5"),
      "moonshot/kimi-k2.6": m("moonshot/kimi-k2.6", "Kimi K2.6"),
    },
  },
  ...
  // 7) PPIO 派欧云
  {
    ...
    pricing: { model: "retail" },
    features: ["openai_compatible", "cn_region"],
    providers: ["deepseek", "qwen", "meta", "minimax"],
    model_count: 0,
    region: ["cn", "global"],
    status: "operational",
    updated_at: "2026-08-20",
  ...
  // 10) NVIDIA MIM
  {
    ...
    providers: ["zhipu", "minimax", "meta", "deepseek"],
    model_count: 0,
    region: ["global"],
    status: "operational",
    updated_at: "2026-08-20",
  ...
  // 13) OpenCode —— 开源 AI 编码工具（需核实额度）
  {
    ...
    providers: ["openai", "anthropic", "deepseek", "google", "zhipu", "qwen", "moonshot", "minimax", "xai"],
    model_count: 0,
    region: ["global"],
    status: "operational",
    updated_at: "2026-08-20",
    models: {
      "openai/gpt-5.1": m("openai/gpt-5.1", "GPT-5.1"),
      "openai/gpt-5.2-codex": m("openai/gpt-5.2-codex", "GPT-5.2 Codex"),
      "openai/gpt-5.6-sol": m("openai/gpt-5.6-sol", "GPT-5.6 Sol"),
      "anthropic/claude-sonnet-4.6": m("anthropic/claude-sonnet-4.6", "Claude Sonnet 4.6"),
      "anthropic/claude-opus-4.8": m("anthropic/claude-opus-4.8", "Claude Opus 4.8"),
      "anthropic/claude-opus-5": m("anthropic/claude-opus-5", "Claude Opus 5"),
      "deepseek/deepseek-v4-flash": m("deepseek/deepseek-v4-flash", "DeepSeek V4 Flash"),
      "deepseek/deepseek-v4-pro": m("deepseek/deepseek-v4-pro", "DeepSeek V4 Pro"),
      "google/gemini-3.1-pro-preview": m("google/gemini-3.1-pro-preview", "Gemini 3.1 Pro Preview"),
      "zhipu/glm-4.7": m("zhipu/glm-4.7", "GLM-4.7"),
      "zhipu/glm-5.2": m("zhipu/glm-5.2", "GLM-5.2"),
      "qwen/qwen3.6-plus": m("qwen/qwen3.6-plus", "Qwen3.6 Plus"),
      "moonshot/kimi-k2.5": m("moonshot/kimi-k2.5", "Kimi K2.5"),
      "moonshot/kimi-k2.6": m("moonshot/kimi-k2.6", "Kimi K2.6"),
      "minimax/MiniMax-M3": m("minimax/MiniMax-M3", "MiniMax-M3"),
      "xai/grok-4.5": m("xai/grok-4.5", "Grok 4.5"),
      "xai/grok-4.6": m("xai/grok-4.6", "Grok 4.6"),
    },
  },
];
