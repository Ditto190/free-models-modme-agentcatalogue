 ...
 */
export function datasetLd(catalog: CatalogJson, base: string = SITE_URL) {
 ...
 */
export function relayOrgLd(relay: Relay, base: string = SITE_URL) {
  ...
  return {
    ...
    name: relay.name,
    url: relay.url,
    mainEntityOfPage: `${base}/relay/${relay.id}`,
    description:
